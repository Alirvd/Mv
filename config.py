...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/v_vnn")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/v_vnn")

SUDO_USERS = list(map(int, getenv("SUDO_USERS", "6520964976").split()))
